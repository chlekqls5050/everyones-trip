                        ...
                        <ul className={style.Depth_1}>
                            <li>
                                ...
                                <ul className={style.Depth_2}>
                                    <li><Link href={'/list/12'}>관광지</Link></li>
                                    <li><Link href={'/list/14'}>문화시설</Link></li>
                                    <li><Link href={'/list/15'}>축제공연행사</Link></li>
                                    <li><Link href={'/list/25'}>여행코스</Link></li>
                                    <li><Link href={'/list/28'}>레포츠</Link></li>
                                    <li><Link href={'/list/32'}>숙박</Link></li>
                                    <li><Link href={'/list/38'}>쇼핑</Link></li>
                                    <li><Link href={'/list/39'}>음식점</Link></li>
                                </ul>
                            </li>
                            <li>
                                <p className={style.Depth_1_title}>Notice</p>
                                <ul className={style.Depth_2}>
                                    <li><Link href={'/board/list'}>공지사항</Link></li>
                                    <li><Link href={'/board/list'}>질문</Link></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
